...
fn test_stringify_primitives() {
    assert_eq!(stringify(&json_parser::core::json_value::JsonValue::Null), "null");
    assert_eq!(stringify(&json_parser::core::json_value::JsonValue::Boolean(true)), "true");
    assert_eq!(stringify(&json_parser::core::json_value::JsonValue::Boolean(false)), "false");
    assert_eq!(stringify(&json_parser::core::json_value::JsonValue::Number(123.45)), "123.45");
}

#[test]
fn test_stringify_strings() {
    assert_eq!(stringify(&json_parser::core::json_value::JsonValue::String("hello".to_string())), r#""hello""#);
    
    // Test escapes
    let string_with_escapes = "line1\nline2\t\"quote\" \\slash";
    let json_val = json_parser::core::json_value::JsonValue::String(string_with_escapes.to_string());
